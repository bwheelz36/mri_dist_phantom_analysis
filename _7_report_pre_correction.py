...
try:
    ...
    volume = MarkerVolume(dataloc / scans['17'] / 'Original' / 'slicer_centroids.mrk.json')
except FileNotFoundError:
    # otherwise resegment
    volume = MarkerVolume(dataloc / scans['17'] / 'Original',
...
rotated_match.MatchedCentroids.to_csv('_data/tra_markers.csv')

# generate a report based on uncorrected volume
...
report.write_html_report(report_name='pre_correction_direct_data.html')